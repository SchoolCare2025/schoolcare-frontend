	...
	return (
		<SelectPrimitive.Trigger
			...
			className={cnMerge(
				...
				dark:aria-invalid:ring-shadcn-destructive/40 flex w-full items-center justify-between gap-2
				rounded-md border border-shadcn-input bg-transparent px-3 py-2 text-sm whitespace-nowrap
				shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-shadcn-ring
				focus-visible:ring-[3px] focus-visible:ring-shadcn-ring/50 disabled:cursor-not-allowed
				disabled:opacity-50 data-[placeholder]:text-shadcn-muted-foreground
				*:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex
				*:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2
				dark:bg-shadcn-input/30 dark:hover:bg-shadcn-input/50 [&_svg]:pointer-events-none
