		...
		<div>
			...
			<div
				className="bg-bgTestimonials-65 sm:grid sm:gap-12 sm:px-10 sm:py-12 md:grid-cols-2 md:gap-10
					md:px-12"
			>
				<div className="rounded-xl bg-cosWhite text-center sm:px-6 sm:py-12 md:h-72 md:py-7 lg:w-[100%]">
					<div>
				...
				<div>
					...
					<div
						className="rounded-xl bg-cosWhite text-center sm:mt-12 sm:px-6 sm:py-7 md:col-start-2
							md:mt-6 md:flex md:h-48 md:grid-rows-1 md:items-center md:px-4 lg:w-[100%] sxl:w-[90%]"
					>
						<div className="mr-3">
