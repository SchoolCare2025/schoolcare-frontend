const Services = () => {
	return (
		<div className="my-40">
			...
			>
				<div
					className="border-borderBottom3 bg-cosWhite flex h-[30vh] w-full items-center rounded-lg
						border-b-8 px-4 font-bold text-black shadow-2xl"
					data-aos="fade-up"
				>
					<div className="bg-slitePlink flex h-12 w-12 items-center justify-center rounded-full">
				...
				<div
					className="border-cosBorder bg-cosWhite flex h-[35vh] w-[100%] items-center rounded-lg
						border-b-8 px-4 font-bold text-black shadow-2xl md:h-[30vh] md:w-full"
					data-aos="fade-up"
				>
					<div className="bg-slitePlink flex h-12 w-12 items-center justify-center rounded-full">
						<i className="ri-school-line text-[36px] md:text-[44px]"></i>
				...
				<div
					className="border-borderBottom3 bg-cosWhite flex h-[35vh] w-[100%] items-center rounded-lg
						border-b-8 px-4 font-bold text-black shadow-2xl md:h-[30vh] md:w-full"
					data-aos="fade-up"
				>
					<div className="bg-slitePlink flex h-12 w-12 items-center justify-center rounded-full">
				...
				<div
					className="border-borderBottom2 bg-cosWhite flex h-[35vh] w-[100%] items-center rounded-lg
						border-b-8 px-4 font-bold text-black shadow-2xl md:h-[30vh] md:w-full"
					data-aos="fade-up"
				>
					<div className="bg-slitePlink flex h-12 w-12 items-center justify-center rounded-full">
