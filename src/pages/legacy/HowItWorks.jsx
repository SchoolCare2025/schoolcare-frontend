				...
				<div className="flex items-center justify-center gap-3">
					...
					<div className="grid gap-2">
						...
						<p className="text-[18px]">
							...
							on submit button for the system to complete the final computation of the final result
							of each of the students. The school ICT admin updates the status so that the students
							can view their individual results. Note: Only the admin can change the status.
						</p>
					</div>
				</div>
			</div>
			...
			<div className="bg-footerBg rounded-lg px-10 py-10">
				...
				<div className="flex items-center justify-center gap-3">
					...
					<div className="grid gap-2">
						...
						<p className="text-[18px]">
							Distribute result checking scratch cards to students. The scratch card pin is
							essential for the student to be able check result. Get these cards from our resellers
							or directly from us, delivered promptly. Note: Each card is valid for one student per
							term and can check the result up to 5 times. For more details, visit our FAQ page.
						</p>
					</div>
				</div>
			</div>
